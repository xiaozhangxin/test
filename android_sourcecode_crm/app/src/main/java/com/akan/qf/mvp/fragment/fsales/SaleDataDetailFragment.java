...
public class SaleDataDetailFragment extends SimpleFragment {
    ...
    TextView tvFour;
    private SaleDataBean taskBean;
    private ArrayList<MonthBean> list;
    private DispatchAdapter adapter;

    public static SaleDataDetailFragment newInstance(SaleDataBean taskBean) {
        Bundle args = new Bundle();
        SaleDataDetailFragment fragment = new SaleDataDetailFragment();
    ...
    public void initUI() {
        ...
        tvTitle.setText("销量统计详情");
        tvTopFour.setText("完成量");
        ...
        values.add(new BarEntry(2, (taskBean.getMonth3()+taskBean.getMonth5()+taskBean.getMonth6())));
        ...
        //第二部分
        list = new ArrayList<>();
        list.add(new MonthBean("月份", "实际完成量(元)"));
        list.add(new MonthBean("月份", "实际完成量(元)"));
        ...
        tvOne.setText(taskBean.getRegion()+taskBean.getBig_area()+taskBean.getArea());
        tvThree.setText(taskBean.getYear() + "年");
        DecimalFormat df = new DecimalFormat("#0");
        tvFour.setText( addComma(taskBean.getSum_money()+"")+"元");
    }

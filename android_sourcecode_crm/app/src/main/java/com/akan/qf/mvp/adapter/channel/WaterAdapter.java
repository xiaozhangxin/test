...
public class WaterAdapter extends RecyclerArrayAdapter<WaterBean> {
    ...
    public class ViewHolder extends BaseViewHolder<WaterBean> {
        ...
        @Override
        public void setData(WaterBean data) {
            super.setData(data);

...
public class ImagePayAdapter extends RecyclerArrayAdapter<FileListBean> {


    public ImagePayAdapter(Context context, List<FileListBean> objects) {
    ...
    public class MyImageHolder extends BaseViewHolder<FileListBean> {
        ...
        public void setData(final FileListBean data) {
            ...
            String upUrl = data.getUp_url();
            if (upUrl.endsWith(".jpg") | upUrl.endsWith(".png")|upUrl.endsWith(".jpeg")) {
                Glide.with(getContext())
                        .load(Constants.BASE_URL + data.getUp_url())

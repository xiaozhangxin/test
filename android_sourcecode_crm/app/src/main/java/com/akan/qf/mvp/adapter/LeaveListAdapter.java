...
public class LeaveListAdapter extends RecyclerArrayAdapter<LeaveBean> {
    public LeaveListAdapter(Context context, List<LeaveBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<LeaveBean> {
        ...
        @Override
        public void setData(LeaveBean data) {
            super.setData(data);

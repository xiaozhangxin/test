...
public class PeopleLeaveLisAdapter extends RecyclerArrayAdapter<PeopleLeaveBean> {
    public PeopleLeaveLisAdapter(Context context, List<PeopleLeaveBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<PeopleLeaveBean> {
        ...
        @Override
        public void setData(PeopleLeaveBean data) {
            super.setData(data);

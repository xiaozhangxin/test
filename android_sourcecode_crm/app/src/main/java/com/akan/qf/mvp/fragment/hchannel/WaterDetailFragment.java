...
public class WaterDetailFragment extends BaseFragment<IWaterView, WaterPresenter> implements IWaterView {
    ...
    private WaterBean bean;

    private PermissionsBean permissionsBean;

    public static WaterDetailFragment newInstance(String detail_id, PermissionsBean permissionsBean) {
        Bundle args = new Bundle();
        WaterDetailFragment fragment = new WaterDetailFragment();
    ...
    @Override
    public void initUI() {
        tvTitle.setText(R.string.foreman_information_details);
    ...
    private void refresh() {
        ...
        getPresenter().getForemanApply(userBean.getStaff_token(), map);
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.tvRight:
                switch (tvRight.getText().toString()) {
                    case "编辑":
                        startWaterAddFragment(bean, "1", permissionsBean);
                        break;
                    case "删除":
                        toDelete();
                        break;
    ...
    private void toDelete() {
        ...
        builder.setPositiveButton(getString(R.string.ok), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                getPresenter().deleteForemanApply(userBean.getStaff_token(), map);
            }
        });
    ...
    private void startDayReviewFragment(String type) {
        ...
        fragment.setOnReviewClickListener(new ReviewFragment.OnReviewClickListener() {
            ...
            public void ok(String content) {
                ...
                map.put("operation", "3");
                map.put("module_id", permissionsBean.getMenu_id());
                getPresenter().auditForemanApply(userBean.getStaff_token(), map);
            }
        });
    ...
    public void OnDeleteForemanApply(String data) {
        EventBus.getDefault().post(new FirstEventFilter("water_delete"));
        ToastUtil.showToast(context.getApplicationContext(), data);
        finish();
    }
}
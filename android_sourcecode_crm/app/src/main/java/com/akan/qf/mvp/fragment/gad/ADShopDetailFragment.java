...
public class ADShopDetailFragment extends BaseFragment<IADManagementView, ADManagementPresenter> implements IADManagementView {
    ...
    public static ADShopDetailFragment newInstance(String detail_id, PermissionsBean permissionsBean) {
        Bundle args = new Bundle();
        ADShopDetailFragment fragment = new ADShopDetailFragment();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tvRight:
                ...
                switch (s) {
                    case "编辑":
                        startADShopAddFragment(bean, "1", permissionsBean);
                        break;
                    case "删除":
                        toDelete();
                        break;
    ...
    private void startDayReviewFragment(String type) {
        ...
        fragment.show(getFragmentManager(), ADShopDetailFragment.class.getSimpleName());
    }
    ...
    public void onDdeleteAdvertApply(String data) {
        EventBus.getDefault().post(new FirstEventFilter("adShop_delete"));
        ToastUtil.showToast(context.getApplicationContext(), data);
        finish();
    }

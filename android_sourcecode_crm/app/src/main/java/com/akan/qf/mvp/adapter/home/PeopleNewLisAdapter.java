...
public class PeopleNewLisAdapter extends RecyclerArrayAdapter<PeopleNewBean> {
    public PeopleNewLisAdapter(Context context, List<PeopleNewBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<PeopleNewBean> {
        ...
        @Override
        public void setData(PeopleNewBean data) {
            super.setData(data);

...
public class ProjectAdapter extends RecyclerArrayAdapter<StoreApplyBean> {
    public ProjectAdapter(Context context, List<StoreApplyBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<StoreApplyBean> {
        ...
        @Override
        public void setData(StoreApplyBean data) {
            super.setData(data);

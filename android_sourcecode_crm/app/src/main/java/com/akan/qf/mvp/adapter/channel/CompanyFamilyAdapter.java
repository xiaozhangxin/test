...
public class CompanyFamilyAdapter extends RecyclerArrayAdapter<CompanyBean> {
    public CompanyFamilyAdapter(Context context, List<CompanyBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<CompanyBean> {

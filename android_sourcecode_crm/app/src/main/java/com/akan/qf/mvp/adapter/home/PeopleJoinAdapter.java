...
public class PeopleJoinAdapter extends RecyclerArrayAdapter<PeopleJionBean> {
    public PeopleJoinAdapter(Context context, List<PeopleJionBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<PeopleJionBean> {
        ...
        @Override
        public void setData(PeopleJionBean data) {
            super.setData(data);

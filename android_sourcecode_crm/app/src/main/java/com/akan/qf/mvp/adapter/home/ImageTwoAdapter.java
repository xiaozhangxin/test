...
import com.akan.qf.view.img.ShowPictureTwoActivity;
...
public class ImageTwoAdapter extends RecyclerArrayAdapter<PressurePageBean.PiptbBaseTypeBean> {
    ...
    public class ViewHolder extends BaseViewHolder<PressurePageBean.PiptbBaseTypeBean> {
        ...
        public void setData(PressurePageBean.PiptbBaseTypeBean data) {
            ...
            final CommonAdapter<PressurePageBean.PiptbBaseTypeBean.Photos> commonAdapter = new CommonAdapter<PressurePageBean.PiptbBaseTypeBean.Photos>(getContext(), R.layout.item_one_img, (List<PressurePageBean.PiptbBaseTypeBean.Photos>) data.getPhotos()) {
                @Override

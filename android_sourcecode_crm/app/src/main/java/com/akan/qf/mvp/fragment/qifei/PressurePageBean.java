...
import com.akan.qf.mvp.fragment.statistics.ResultListBean;
...
public class PressurePageBean implements Serializable {
    ...
    /**
     * doc_no : SYBD201811280684
     * group_no : 011525010117
     * acc_period :
     * doc_code : 64
     * staff_no : 23030
     * staff_name : 万君培
     * au_staff : 23030
     * trn_date : 2018-11-28 13:51:38
     * post_date :
     * start_time :
     * end_time :
     * post_date_start :
     ...
     * if_post_show : 未审核
     * flow_state : 0
     * address : 湖北省武汉市江岸区高雄路18-附15
     * area : 武汉爱康新型建材
     * house_area_name : 高雄小区13-2-601
     * owner_name : 靖
     * owner_tel : 13971325181
     * attention :
     * is_presence :
     * scene_contact : 张仲林
     * scene_contact_tel : 15342285007
     * declaration_type : 装修公司
     * decoration_company :
     * decoration_company_tel :
     * project_manager :
     * project_manager_tel :
     * book_time : 2018-11-29 00:00:00
     * attention2 :
     * install_type :
     * pipe_type :
     * pipe_brand : 保利
     ...
     * is_photos : 未上传
     * is_weixin : 是
     * weixin_address : 湖北省武汉市江岸区高雄路18-附15
     * is_assign_pressure :
     * owner_weixin_id :
     * photo_count : 0
     * owner_sign :
     * weixin_open_id : odnOct8zAZlMs4h_qoUnUld7lWek
     *
     * flowRecords : []
     * baseTypePhotos : []
     */
    ...
    public void setAu_staff(String au_staff) {
        this.au_staff = au_staff;
    }
    ...
    public List<PiptbBaseTypeBean> getBaseTypePhotos() {
        return baseTypePhotos;
    }

    public void setBaseTypePhotos(List<PiptbBaseTypeBean> baseTypePhotos) {
        this.baseTypePhotos = baseTypePhotos;
    }

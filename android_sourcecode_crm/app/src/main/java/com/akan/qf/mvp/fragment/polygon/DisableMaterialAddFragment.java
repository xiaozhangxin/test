...
public class DisableMaterialAddFragment extends BaseFragment<IADManagementView, ADManagementPresenter> implements IADManagementView {
    ...
    public static DisableMaterialAddFragment newInstance(AdManagementBean bean, String type, PermissionsBean permissionsBean) {
        Bundle args = new Bundle();
        DisableMaterialAddFragment fragment = new DisableMaterialAddFragment();
        fragment.data = bean;
    ...
    public int getRootViewId() {
        return R.layout.fragment_add_disable_material;
    }
    ...
    @OnClick({R.id.tvTopFour, R.id.ivLeft, R.id.ok})

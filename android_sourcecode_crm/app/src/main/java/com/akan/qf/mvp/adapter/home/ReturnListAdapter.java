...
public class ReturnListAdapter extends RecyclerArrayAdapter<RetnrnBean> {
    public ReturnListAdapter(Context context, List<RetnrnBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<RetnrnBean> {
        ...
        @Override
        public void setData(RetnrnBean data) {
            super.setData(data);

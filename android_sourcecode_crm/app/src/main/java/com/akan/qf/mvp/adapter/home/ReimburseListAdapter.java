...
public class ReimburseListAdapter extends RecyclerArrayAdapter<ReimbursementInfoBean> {
    public ReimburseListAdapter(Context context, List<ReimbursementInfoBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<ReimbursementInfoBean> {
        ...
        @Override
        public void setData(ReimbursementInfoBean data) {
            super.setData(data);
            ...
            tvNum.setText(data.getInfo_number());

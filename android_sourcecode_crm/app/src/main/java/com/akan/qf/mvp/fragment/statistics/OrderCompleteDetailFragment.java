...
public class OrderCompleteDetailFragment extends BaseFragment<IPressureView, PressurePresenter> implements IPressureView {
    ...
    public static OrderCompleteDetailFragment newInstance(String doc_id, PermissionsBean permissionsBean) {
    ...
    @Override
    public void OnQueryAreaCountPressurePage(List<BigAreaBean> data) {

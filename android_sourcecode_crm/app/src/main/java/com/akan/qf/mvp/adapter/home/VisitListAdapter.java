...
public class VisitListAdapter extends RecyclerArrayAdapter<VisitorBean> {
    public VisitListAdapter(Context context, List<VisitorBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<VisitorBean> {
        ...
        @Override
        public void setData(VisitorBean data) {
            super.setData(data);

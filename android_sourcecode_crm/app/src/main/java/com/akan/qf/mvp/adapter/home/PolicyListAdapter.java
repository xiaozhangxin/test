...
public class PolicyListAdapter extends RecyclerArrayAdapter<PolicyBean> {
    public PolicyListAdapter(Context context, List<PolicyBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<PolicyBean> {
        ...
        @Override
        public void setData(PolicyBean data) {
            super.setData(data);

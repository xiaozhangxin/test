...
public class ImageLeaveAdapter extends RecyclerArrayAdapter<FileListBean> {


    public ImageLeaveAdapter(Context context, List<FileListBean> objects) {

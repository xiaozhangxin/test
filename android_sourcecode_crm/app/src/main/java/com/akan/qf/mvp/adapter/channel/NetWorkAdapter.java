package com.akan.qf.mvp.adapter.channel;
...
public class NetWorkAdapter extends RecyclerArrayAdapter<NetworkBean> {
    public NetWorkAdapter(Context context, List<NetworkBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<NetworkBean> {
        ...
        @Override
        public void setData(NetworkBean data) {
            super.setData(data);

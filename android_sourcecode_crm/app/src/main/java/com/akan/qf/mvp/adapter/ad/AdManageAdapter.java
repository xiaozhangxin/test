package com.akan.qf.mvp.adapter.ad;
...
public class AdManageAdapter extends RecyclerArrayAdapter<AdManagementBean> {
    public AdManageAdapter(Context context, List<AdManagementBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<AdManagementBean> {
        ...
        @Override
        public void setData(AdManagementBean data) {
            super.setData(data);

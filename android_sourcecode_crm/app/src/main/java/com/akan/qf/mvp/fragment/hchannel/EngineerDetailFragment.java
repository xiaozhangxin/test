...
public class EngineerDetailFragment extends BaseFragment<IProjectView, ProjectPresenter> implements IProjectView {
    ...
    private StoreApplyBean bean;

    private PermissionsBean permissionsBean;

    public static EngineerDetailFragment newInstance(String detail_id, PermissionsBean permissionsBean) {
    ...
    public int getRootViewId() {
        return R.layout.fragment_engineer_detail;
    }

    @Override
    public void initUI() {
        tvTitle.setText(R.string.project_details);
    ...
    private void refresh() {
        ...
        getPresenter().getStoreApply(userBean.getStaff_token(), map);
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.tvRight:
                switch (tvRight.getText().toString()) {
                    case "编辑":
                        startEngineerAddFragment(bean, "1", permissionsBean);
                        break;
                    case "删除":
                        toDelete();
                        break;
    ...
    private void toDelete() {
        ...
        builder.setPositiveButton(getString(R.string.ok), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                getPresenter().deleteStoreApply(userBean.getStaff_token(), map);
            }
        });
    ...
    private void startDayReviewFragment(String type) {
        ...
        fragment.setOnReviewClickListener(new ReviewFragment.OnReviewClickListener() {
            ...
            public void ok(String content) {
                ...
                map.put("operation", "3");
                map.put("module_id", permissionsBean.getMenu_id());
                getPresenter().auditStoreApply(userBean.getStaff_token(), map);
            }
        });
    ...
    public void OndeleteStoreApply(String data) {
        EventBus.getDefault().post(new FirstEventFilter("engineer_delete"));
        ToastUtil.showToast(context.getApplicationContext(), data);
        finish();
    }

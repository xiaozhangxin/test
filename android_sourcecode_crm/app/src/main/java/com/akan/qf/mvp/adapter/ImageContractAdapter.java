...
public class ImageContractAdapter extends RecyclerArrayAdapter<FileNewBean> {


    public ImageContractAdapter(Context context, List<FileNewBean> objects) {
    ...
    public class MyImageHolder extends BaseViewHolder<FileNewBean> {
        ...
        @Override
        public void setData(final FileNewBean data) {

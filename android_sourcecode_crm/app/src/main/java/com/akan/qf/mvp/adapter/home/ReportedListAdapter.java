...
public class ReportedListAdapter extends RecyclerArrayAdapter<ReprotedBean> {
    public ReportedListAdapter(Context context, List<ReprotedBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<ReprotedBean> {
        ...
        @Override
        public void setData(ReprotedBean data) {
            super.setData(data);

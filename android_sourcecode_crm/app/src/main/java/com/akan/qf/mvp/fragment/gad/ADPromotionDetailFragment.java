...
public class ADPromotionDetailFragment extends BaseFragment<IADManagementView, ADManagementPresenter> implements IADManagementView {
    ...
    public static ADPromotionDetailFragment newInstance(String detail_id, PermissionsBean permissionsBean) {
        Bundle args = new Bundle();
        ADPromotionDetailFragment fragment = new ADPromotionDetailFragment();
    ...
    public void initUI() {
        tvPee.setText("投入费用");
        tvAddress.setText("推广地址");

        tvImgTittle.setText("现场图片上传");
        tvTitle.setText("推广广告详情");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tvRight:
                ...
                switch (s) {
                    case "编辑":
                        startADPromotionAddFragment(bean, "1", permissionsBean);
                        break;
                    case "删除":
                        toDelete();
                        break;
    ...
    private void startDayReviewFragment(String type) {
        ...
        fragment.show(getFragmentManager(), ADPromotionDetailFragment.class.getSimpleName());
    }
    ...
    public void onDdeleteAdvertApply(String data) {
        EventBus.getDefault().post(new FirstEventFilter("adPromotion_delete"));
        ToastUtil.showToast(context.getApplicationContext(), data);
        finish();
    }

...
public class ArrearsAdapter extends RecyclerArrayAdapter<DebtApplyBean> {
    public ArrearsAdapter(Context context, List<DebtApplyBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<DebtApplyBean> {
        ...
        @Override
        public void setData(DebtApplyBean data) {
            super.setData(data);

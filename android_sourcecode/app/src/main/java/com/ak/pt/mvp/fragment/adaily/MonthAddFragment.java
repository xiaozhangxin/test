...
public class MonthAddFragment extends BaseFragment<IDailyView, DailyPresenter> implements IDailyView {
    ...
    public static MonthAddFragment newInstance(DailyBean bean, String type,AppPermissionsBean permissionsBean) {
    ...
    public void initUI() {
        ...
        if ("0".equals(type)) {
            ...
            tvTitle.setText(R.string.month_add);
        } else {
            tvTitle.setText(R.string.month_update);

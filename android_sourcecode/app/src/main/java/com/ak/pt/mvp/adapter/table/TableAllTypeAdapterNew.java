...
public class TableAllTypeAdapterNew extends RecyclerArrayAdapter<InstallFormBean> {
    public TableAllTypeAdapterNew(Context context, List<InstallFormBean> list) {
        super(context, list);
    }

    @Override
    public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
        return new TableAllTypeAdapterNew.ViewHolder(parent, viewType);
    }
    ...
    public class ViewHolder extends BaseViewHolder<InstallFormBean> {
        ...
        public void setData(InstallFormBean data) {
            ...
            } else if (type.contains("电话")) {
                tvData.setText(data.getTel());
            } else if (type.contains("姓名")|type.contains("名称")) {

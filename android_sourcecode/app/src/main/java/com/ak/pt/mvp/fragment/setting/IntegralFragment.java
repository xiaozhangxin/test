...
import com.ak.pt.mvp.adapter.IntegralAdapter;
...
public class IntegralFragment extends BaseFragment<IIntegralView, IntegralPresenter> implements IIntegralView {
    ...
    public void initUI() {
        ...
        adapter = new IntegralAdapter(context, list);
    ...
    private void refresh() {
        ...
        getPresenter().getIntegralDailyList(userBean.getStaff_token(), map);
    }

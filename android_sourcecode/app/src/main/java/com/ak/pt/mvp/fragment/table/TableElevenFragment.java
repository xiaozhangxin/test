...
public class TableElevenFragment extends BaseFragment<IAllTableView, AllTablePresenter> implements IAllTableView {
    Unbinder unbinder;
    ...
    public static TableElevenFragment newInstance() {
        Bundle args = new Bundle();
        TableElevenFragment fragment = new TableElevenFragment();
    ...
    private void refresh() {
        map.put("page", page + "");
        getPresenter().getOwnerForm(userBean.getStaff_token(), map);
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ivLeft:
                ...
                break;
            case R.id.tvType:
                showSingleDialog(new String[]{"业主信息收集量", "业主信息收集率"});
                break;

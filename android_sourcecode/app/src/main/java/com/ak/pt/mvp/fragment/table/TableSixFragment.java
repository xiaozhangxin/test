...
public class TableSixFragment extends BaseFragment<IAllTableView, AllTablePresenter> implements IAllTableView {
    Unbinder unbinder;
    ...
    public static TableSixFragment newInstance() {
        Bundle args = new Bundle();
        TableSixFragment fragment = new TableSixFragment();
    ...
    private void refresh() {
        map.put("page", page + "");
        getPresenter().getHydraulicNameForm(userBean.getStaff_token(), map);
    }

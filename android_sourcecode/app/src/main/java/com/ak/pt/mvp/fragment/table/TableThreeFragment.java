...
public class TableThreeFragment extends BaseFragment<IAllTableView, AllTablePresenter> implements IAllTableView {
    Unbinder unbinder;
    ...
    public static TableThreeFragment newInstance() {
        Bundle args = new Bundle();
        TableThreeFragment fragment = new TableThreeFragment();
    ...
    @Override
    public void initUI() {
        tvType.setText("经销商名称");
        tvTitle.setText("经销商统计报表");
        list = new ArrayList<>();
    ...
    private void refresh() {
        map.put("page", page + "");
        getPresenter().getDistributorForm(userBean.getStaff_token(), map);
    }

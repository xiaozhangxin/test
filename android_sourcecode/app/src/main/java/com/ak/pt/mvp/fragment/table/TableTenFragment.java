...
public class TableTenFragment extends BaseFragment<IAllTableView, AllTablePresenter> implements IAllTableView {
    Unbinder unbinder;
    ...
    public static TableTenFragment newInstance() {
        Bundle args = new Bundle();
        TableTenFragment fragment = new TableTenFragment();
    ...
    private void refresh() {
        map.put("page", page + "");
        getPresenter().getHouseNameForm(userBean.getStaff_token(), map);
    }

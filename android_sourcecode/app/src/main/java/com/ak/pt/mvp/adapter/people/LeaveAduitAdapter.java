...
public class LeaveAduitAdapter extends RecyclerArrayAdapter<RecordListBean> {


    public LeaveAduitAdapter(Context context, List<RecordListBean> objects) {
        super(context, objects);
    }

    @Override
    public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
        return new LeaveAduitAdapter.MyImageHolder(parent, R.layout.item_people_audit);
    }

...
public class TableTwoFragment extends BaseFragment<IAllTableView, AllTablePresenter> implements IAllTableView {
    Unbinder unbinder;
    ...
    public static TableTwoFragment newInstance() {
        Bundle args = new Bundle();
        TableTwoFragment fragment = new TableTwoFragment();
    ...
    private void refresh() {
        map.put("page", page + "");
        getPresenter().getPipeTrendForm(userBean.getStaff_token(), map);
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ivLeft:
                ...
                break;
            case R.id.tvType:
                showSingleDialog(new String[]{"走顶", "走地", "走墙"});
                break;

...
public class FeedbackActivity extends PureActivity {
    ...
    @BindView(R.id.rg)
    RadioGroup rg;
    private FeedbackAddFragment signFragment;
    private FeedbackListFragment signRecordFragment;
    ...
    public void showsignFragment() {
        ...
        if (signFragment == null) {
            signFragment = FeedbackAddFragment.newInstance(new FeedBackBean(),"0",permissionsBean);
    ...
    public void showsignRecordFragment() {
        ...
        if (signRecordFragment == null) {
            signRecordFragment = FeedbackListFragment.newInstance(permissionsBean);

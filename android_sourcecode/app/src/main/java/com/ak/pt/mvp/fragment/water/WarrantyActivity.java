...
public class WarrantyActivity extends PureActivity {
    ...
    @BindView(R.id.rg)
    RadioGroup rg;
    private WarrantyAddFragment signFragment;
    private WarrantyListFragment signRecordFragment;
    ...
    public void showsignFragment() {
        ...
        if (signFragment == null) {
            signFragment = WarrantyAddFragment.newInstance(new WarrantyBean(),"0",permissionsBean);
    ...
    public void showsignRecordFragment() {
        ...
        if (signRecordFragment == null) {
            signRecordFragment = WarrantyListFragment.newInstance(permissionsBean);

...
public class TableNineFragment extends BaseFragment<IAllTableView, AllTablePresenter> implements IAllTableView {
    Unbinder unbinder;
    ...
    public static TableNineFragment newInstance() {
        Bundle args = new Bundle();
        TableNineFragment fragment = new TableNineFragment();
    ...
    private void refresh() {
        map.put("page", page + "");
        getPresenter().getProjectManagerForm(userBean.getStaff_token(), map);
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ivLeft:
                ...
                break;
            case R.id.tvType:
                showSingleDialog(new String[]{"代理商名称", "代理商电话", "项目经理名称"});

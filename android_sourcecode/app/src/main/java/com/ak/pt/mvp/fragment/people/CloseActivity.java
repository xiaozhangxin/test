...
public class CloseActivity extends PureActivity {


    private RadioGroup mRadioGroup;
    private CloseAddFragment signFragment;
    private CloseListFragment signRecordFragment;
    ...
    public void showsignFragment() {
        ...
        if (signFragment == null) {
            signFragment = CloseAddFragment.newInstance(new ShopCloseBean(), "0", permissionsBean);
    ...
    public void showsignRecordFragment() {
        ...
        if (signRecordFragment == null) {
            signRecordFragment = CloseListFragment.newInstance(permissionsBean);

...
public class DailyActivity extends PureActivity {



    private RadioGroup rg;
    private DailyAddFragment signFragment;
    private DailyListFragment signRecordFragment;
    ...
    public void showsignFragment() {
        ...
        if (signFragment == null) {
            signFragment = DailyAddFragment.newInstance(new DailyBean(), "0",permissionsBean);
    ...
    public void showsignRecordFragment() {
        ...
        if (signRecordFragment == null) {
            signRecordFragment = DailyListFragment.newInstance(permissionsBean);

...
public class TableTwelveFragment extends BaseFragment<IAllTableView, AllTablePresenter> implements IAllTableView {
    Unbinder unbinder;
    ...
    public static TableTwelveFragment newInstance() {
        Bundle args = new Bundle();
        TableTwelveFragment fragment = new TableTwelveFragment();
    ...
    private void refresh() {
        map.put("page", page + "");
        getPresenter().getTimelyForm(userBean.getStaff_token(), map);
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ivLeft:
                ...
                break;
            case R.id.tvType:
                showSingleDialog(new String[]{"未及时审核率", "未及时审核数量"});
                break;

...
public class UpImgPresenter extends BasePresenter<IUpImgView>{
    public UpImgPresenter(App app) {
        super(app);
    }

    public void insertPiptbFixPhoto(String token, Map<String, String> map) {
        getAppComponent().getAPIService()
                .insertPiptbFixPhoto(token,map)
                ...
                .subscribe(new Observer<HttpResult<String>>() {
                    ...
                    public void onNext(HttpResult<String> userBeanHttpResult) {
                        if (userBeanHttpResult != null) {
                            if (isViewAttached()) {
                                getView().onInsertPiptbFixPhoto(userBeanHttpResult.getData());
                            }
                        }
                    }
                });

...
public class MonthlySummaryActivity extends PureActivity {
    ...
    @BindView(R.id.rg)
    RadioGroup rg;
    private MonthlySummaryAddFragment signFragment;
    private MonthlySummaryListFragment signRecordFragment;
    ...
    public void showsignFragment() {
        ...
        if (signFragment == null) {
            signFragment = MonthlySummaryAddFragment.newInstance(new MonthTotalBean(),"0",permissionsBean);
    ...
    public void showsignRecordFragment() {
        ...
        if (signRecordFragment == null) {
            signRecordFragment = MonthlySummaryListFragment.newInstance(permissionsBean);

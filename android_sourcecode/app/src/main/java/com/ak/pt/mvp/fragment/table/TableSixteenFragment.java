...
public class TableSixteenFragment extends BaseFragment<IAllTableView, AllTablePresenter> implements IAllTableView {
    Unbinder unbinder;
    ...
    public static TableSixteenFragment newInstance() {
        Bundle args = new Bundle();
        TableSixteenFragment fragment = new TableSixteenFragment();
    ...
    public void initUI() {
        ...
        tvTitle.setText("装饰公司名称报表");
        tvType.setText("装饰公司名称");
        list = new ArrayList<>();
    ...
    private void refresh() {
        map.put("page", page + "");
        getPresenter().getDecorateCompanyForm(userBean.getStaff_token(), map);
    }

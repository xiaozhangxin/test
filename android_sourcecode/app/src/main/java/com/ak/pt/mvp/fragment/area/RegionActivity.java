...
public class RegionActivity extends PureActivity {
    ...
    @BindView(R.id.rg)
    RadioGroup rg;
    private RegionAddFragment signFragment;
    private RegionListFragment signRecordFragment;
    ...
    public void showsignFragment() {
        ...
        if (signFragment == null) {
            signFragment = RegionAddFragment.newInstance(new AreaStudyBean(),"0",permissionsBean);
    ...
    public void showsignRecordFragment() {
        ...
        if (signRecordFragment == null) {
            signRecordFragment = RegionListFragment.newInstance(permissionsBean);

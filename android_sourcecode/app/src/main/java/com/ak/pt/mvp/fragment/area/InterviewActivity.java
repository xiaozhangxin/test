...
public class InterviewActivity extends PureActivity {
    ...
    @BindView(R.id.rg)
    RadioGroup rg;
    private InterviewAddFragment signFragment;
    private InterviewListFragment signRecordFragment;
    ...
    public void showsignFragment() {
        ...
        if (signFragment == null) {
            signFragment = InterviewAddFragment.newInstance(new InterviewBean(),"0",permissionsBean);
    ...
    public void showsignRecordFragment() {
        ...
        if (signRecordFragment == null) {
            signRecordFragment = InterviewListFragment.newInstance(permissionsBean);

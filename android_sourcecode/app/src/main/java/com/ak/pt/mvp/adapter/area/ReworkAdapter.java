...
public class ReworkAdapter extends RecyclerArrayAdapter<PressureBackBean> {
    public ReworkAdapter(Context context, List<PressureBackBean> list) {
        super(context, list);
    }
    ...
    public class ViewHolder extends BaseViewHolder<PressureBackBean> {
        ...
        @Override
        public void setData(PressureBackBean data) {
            super.setData(data);

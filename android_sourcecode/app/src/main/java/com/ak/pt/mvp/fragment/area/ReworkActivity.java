...
public class ReworkActivity extends PureActivity {
    ...
    @BindView(R.id.rg)
    RadioGroup rg;
    private ReworkAddFragment signFragment;
    private ReworkListFragment signRecordFragment;
    ...
    public void showsignFragment() {
        ...
        if (signFragment == null) {
            signFragment = ReworkAddFragment.newInstance(new PressureBackBean(),"0",permissionsBean);
    ...
    public void showsignRecordFragment() {
        ...
        if (signRecordFragment == null) {
            signRecordFragment = ReworkListFragment.newInstance(permissionsBean);

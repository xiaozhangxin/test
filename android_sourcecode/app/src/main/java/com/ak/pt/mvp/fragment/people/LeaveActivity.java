...
public class LeaveActivity extends PureActivity {


    private RadioGroup mRadioGroup;
    private LeaveAddFragment signFragment;
    private LeaveListFragment signRecordFragment;
    ...
    public void showsignFragment() {
        ...
        if (signFragment == null) {
            signFragment = LeaveAddFragment.newInstance(new QuitJobBean(), "0", permissionsBean);
    ...
    public void showsignRecordFragment() {
        ...
        if (signRecordFragment == null) {
            signRecordFragment = LeaveListFragment.newInstance(permissionsBean);

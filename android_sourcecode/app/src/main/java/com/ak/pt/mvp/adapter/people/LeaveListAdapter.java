...
public class LeaveListAdapter extends RecyclerArrayAdapter<QuitJobBean> {
    public LeaveListAdapter(Context context, List<QuitJobBean> list) {
        super(context, list);
    }

    @Override
    public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
        return new LeaveListAdapter.ViewHolder(parent, viewType);
    }

    public class ViewHolder extends BaseViewHolder<QuitJobBean> {
        ...
        @Override
        public void setData(QuitJobBean data) {
            super.setData(data);

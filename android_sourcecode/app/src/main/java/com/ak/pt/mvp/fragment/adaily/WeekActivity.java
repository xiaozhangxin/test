...
public class WeekActivity extends PureActivity {


    private RadioGroup rg;
    private WeeklyAddFragment signFragment;
    private WeeklyListFragment signRecordFragment;
    ...
    public void showsignFragment() {
        ...
        if (signFragment == null) {
            signFragment = WeeklyAddFragment.newInstance(new DailyBean(), "0",permissionsBean);
    ...
    public void showsignRecordFragment() {
        ...
        if (signRecordFragment == null) {
            signRecordFragment = WeeklyListFragment.newInstance(permissionsBean);

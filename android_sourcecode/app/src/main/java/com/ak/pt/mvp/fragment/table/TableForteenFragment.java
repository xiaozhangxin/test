...
public class TableForteenFragment extends BaseFragment<IAllTableView, AllTablePresenter> implements IAllTableView {
    Unbinder unbinder;
    ...
    public static TableForteenFragment newInstance() {
        Bundle args = new Bundle();
        TableForteenFragment fragment = new TableForteenFragment();
    ...
    private void refresh() {
        map.put("page", page + "");
        getPresenter().getAuthenticityForm(userBean.getStaff_token(), map);
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ivLeft:
                ...
                break;
            case R.id.tvType:
                showSingleDialog(new String[]{"试压员姓名", "真伪查询数量", "真伪查询率"});
                break;

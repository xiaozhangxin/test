...
public class PressureeginActivity extends AppCompatActivity {
...
//        data.setText(hexString);
        ...
        if (hexString.length() >= 38) {
            ...
            switch (state) {
                ...
                case "1":
                    ...
                    break;
                case "2":
                    BeepUtils.fail(PressureeginActivity.this);
                    ...
                    break;
                case "3"://试压合格
                    BeepUtils.success(PressureeginActivity.this);
                    toSavePressureData(startSize, nowSize);
   ...
   private String moduleTime ="";
            ...
            case R.id.tvStartOrEnd:
                if (ptState) {//试压是否开始
                    ...
                    if (isKgSelect) {
                        ...
                        BeepUtils.selectKg(PressureeginActivity.this);
                    }
    ...
    private void startPressure(int kgInt) {
        BeepUtils.startPt(PressureeginActivity.this);
        tvStartOrEnd.setImageResource(R.drawable.pt_end);
        ...
        switch (mTimes) {
            case "1":
                if (!times.equals(mTimes)) {
                    BeepUtils.oneBegin(PressureeginActivity.this);
            ...
            case "2":
                ptBean.setPressure_start_value(tvStartPt.getText().toString());
                if (!times.equals(mTimes)) {
                    BeepUtils.oneOver(PressureeginActivity.this);
                }
                times = mTimes;
                break;
            case "3":
                if (!times.equals(mTimes)) {
                    BeepUtils.twoOver(PressureeginActivity.this);
                }
                times = mTimes;
                break;
            case "4":
                if (!times.equals(mTimes)) {
                    BeepUtils.threeOver(PressureeginActivity.this);
                }
                times = mTimes;
                break;
            ...
            case "5":
                if (!times.equals(mTimes)) {
                    BeepUtils.fourOver(PressureeginActivity.this);
                }
                times = mTimes;
                break;
        }
    ...
    private void chooseModeVoice(int kgInt) {
        switch (kgInt) {
            case 1:
                BeepUtils.chooseOne(PressureeginActivity.this);
                break;
            case 2:
                BeepUtils.chooseTwo(PressureeginActivity.this);
                break;
            case 3:
                BeepUtils.chooseThree(PressureeginActivity.this);
                break;
            case 4:
                BeepUtils.chooseFour(PressureeginActivity.this);
                break;
            case 5:
                BeepUtils.chooseFive(PressureeginActivity.this);
                break;
            case 6:
                BeepUtils.chooseSix(PressureeginActivity.this);
                break;
            case 7:
                BeepUtils.chooseSeven(PressureeginActivity.this);
                break;
            case 8:
                BeepUtils.chooseEight(PressureeginActivity.this);
                break;
            case 9:
                BeepUtils.chooseNine(PressureeginActivity.this);
                break;
            case 10:
                BeepUtils.chooseTen(PressureeginActivity.this);
                break;
            case 11:
                BeepUtils.chooseEleven(PressureeginActivity.this);
                break;
            case 12:
                BeepUtils.chooseTwelve(PressureeginActivity.this);
                break;
            case 13:
                BeepUtils.chooseThirteen(PressureeginActivity.this);
                break;
            case 14:
                BeepUtils.chooseFourteen(PressureeginActivity.this);
                break;
            case 15:
                BeepUtils.chooseFifteen(PressureeginActivity.this);
                break;
            case 16:
                BeepUtils.chooseSixteen(PressureeginActivity.this);
                break;
        }
    }

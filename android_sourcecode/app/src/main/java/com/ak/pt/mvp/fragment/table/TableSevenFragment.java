...
public class TableSevenFragment extends BaseFragment<IAllTableView, AllTablePresenter> implements IAllTableView {
    Unbinder unbinder;
    ...
    public static TableSevenFragment newInstance() {
        Bundle args = new Bundle();
        TableSevenFragment fragment = new TableSevenFragment();
    ...
    private void refresh() {
        map.put("page", page + "");
        getPresenter().getEventForm(userBean.getStaff_token(), map);
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ivLeft:
                ...
                break;
            case R.id.tvType:
                showSingleDialog(new String[]{"问题名称", "问题出现次数", "问题出现率"});
                break;

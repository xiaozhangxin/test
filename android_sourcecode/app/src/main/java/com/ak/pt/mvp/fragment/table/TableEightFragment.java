...
public class TableEightFragment extends BaseFragment<IAllTableView, AllTablePresenter> implements IAllTableView {
    Unbinder unbinder;
    ...
    public static TableEightFragment newInstance() {
        Bundle args = new Bundle();
        TableEightFragment fragment = new TableEightFragment();
    ...
    private void refresh() {
        map.put("page", page + "");
        getPresenter().getSpoolTypeForm(userBean.getStaff_token(), map);
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ivLeft:
                ...
                break;
            case R.id.tvType:
                showSingleDialog(new String[]{"保利", "伟星", "金牛", "日丰", "联塑", "其他"});
                break;

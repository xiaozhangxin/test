...
public class TableAllTypeAdapterTwo extends RecyclerArrayAdapter<InstallFormBean> {
    public TableAllTypeAdapterTwo(Context context, List<InstallFormBean> list) {
        super(context, list);
    }

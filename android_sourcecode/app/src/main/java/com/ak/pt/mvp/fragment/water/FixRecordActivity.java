...
public class FixRecordActivity extends PureActivity {
    ...
    @BindView(R.id.rg)
    RadioGroup rg;
    private FixRecordAddFragment signFragment;
    private FixRecordListFragment signRecordFragment;
    ...
    public void showsignFragment() {
        ...
        if (signFragment == null) {
            signFragment = FixRecordAddFragment.newInstance(new FixRecordBean(),"0",permissionsBean);
    ...
    public void showsignRecordFragment() {
        ...
        if (signRecordFragment == null) {
            signRecordFragment = FixRecordListFragment.newInstance(permissionsBean);

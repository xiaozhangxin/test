...
import com.ak.pt.mvp.adapter.InventoryAdapter;
    ...
    public void initUI() {
        ...
        adapter.setOnItemClickListener(new RecyclerArrayAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                JPushInterface.setAlias(context.getApplicationContext(), adapter.getItem(position).getStaff_id(), new TagAliasCallback() {
                    @Override

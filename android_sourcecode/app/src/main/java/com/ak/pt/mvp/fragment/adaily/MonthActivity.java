...
public class MonthActivity extends PureActivity {



    private RadioGroup rg;
    private MonthAddFragment signFragment;
    private MonthListFragment signRecordFragment;
    ...
    public void showsignFragment() {
        ...
        if (signFragment == null) {
            signFragment = MonthAddFragment.newInstance(new DailyBean(),"0",permissionsBean);
    ...
    public void showsignRecordFragment() {
        ...
        if (signRecordFragment == null) {
            signRecordFragment = MonthListFragment.newInstance(permissionsBean);

...
public class MonthDetailFragment extends BaseFragment<IDailyView, DailyPresenter> implements IDailyView {
    ...
    public static MonthDetailFragment newInstance(String daily_id, AppPermissionsBean permissionsBean) {
    ...
    @Override
    public void initUI() {
        tvTitle.setText(R.string.month_detail);
    ...
    private void onDelete() {
        ...
        builder.setMessage(R.string.sure_delete_month);

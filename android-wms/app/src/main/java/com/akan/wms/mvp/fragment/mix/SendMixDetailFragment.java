...
import com.akan.wms.mvp.adapter.mix.SendMixDetailAdapter;
import com.akan.wms.mvp.base.BaseFragment;
import com.akan.wms.mvp.presenter.mix.SendMixPresenter;
...
public class SendMixDetailFragment extends BaseFragment<ISendMixView, SendMixPresenter> implements ISendMixView {
    ...
    private List<ShipBean.LineBeanListBean> list;
    private SendMixDetailAdapter adapter;
    private Map<String, String> map = new HashMap<>();
    private UserBean userBean;
    private String mId;
    private List<RecordsBean> listRecord;
    private RecordAdapter adapterRecord;
    public static SendMixDetailFragment newInstance(String id) {
        Bundle args = new Bundle();
        SendMixDetailFragment fragment = new SendMixDetailFragment();
        fragment.mId = id;
    ...
    @Override
    public void initUI() {
        tvTitle.setText(R.string.mix_send_detail);
        stateOne.setText(R.string.auditing);
        stateTwo.setText(R.string.audit_already);

        list = new ArrayList<>();
        recyclerView.setLayoutManager(new LinearLayoutManager(context));
        adapter = new SendMixDetailAdapter(context, list);
    ...
    private void getData() {
        map.put("id", mId);
        getPresenter().queryShipById(userBean.getStaff_token(), map);
    }

    @Override
    public void onQueryShipById(ShipBean data) {
    ...
    private void showDialog() {
        ...
        builder.setMessage(R.string.audit_pass);
        ...
        builder.setPositiveButton(R.string.sure, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                map.clear();
                map.put("id", mId);
                getPresenter().auditShip(userBean.getStaff_token(), map);
            }
        });
    ...
    @Override
    public SendMixPresenter createPresenter() {
        return new SendMixPresenter(getApp());
    }
    ...
    @Override
    public void onQueryShipPage(List<ShipBean> data) {

    }


    @Override
    public void onAuditShip(String data) {

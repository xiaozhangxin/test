...
public class OutTransferAddNewFragment extends BaseFragment<IOutTransferView, OutTransferPresenter> implements IOutTransferView , FragmentBackHandler {
    ...
    public static OutTransferAddNewFragment newInstance(TransferUnCompleteBean mChooseBean) {
        Bundle args = new Bundle();
        OutTransferAddNewFragment fragment = new OutTransferAddNewFragment();
        fragment.setArguments(args);
        fragment.mChooseBean=mChooseBean;
        return fragment;
    }
    ...
    public void initUI() {
        ...
        for (int i = 0; i < mChooseBean.getLineBeanList().size(); i++) {
            if (mChooseBean.getLineBeanList().get(i).isCheck()) {
                list.add(mChooseBean.getLineBeanList().get(i));
            }
        }
        completeBean.setLineBeanList(list);
        completeBean.setDoc_no(mChooseBean.getDoc_no());
        adapter.clear();
        adapter.add(completeBean);
    ...
    private TransferUnCompleteBean mChooseBean ;

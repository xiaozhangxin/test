...
public class OutApplyTypeFragment extends BaseFragment<IOutApplyTypeView, OutApplyTypePresenter> implements IOutApplyTypeView {
    Unbinder unbinder;
    ...
    public static OutApplyTypeFragment newInstance() {
        Bundle args = new Bundle();
        OutApplyTypeFragment fragment = new OutApplyTypeFragment();
    ...
    public void initData() {
        ...
        getPresenter().queryOutTypeList(userBean.getStaff_token(), map);
    }

...
public class OutSaleAddFragment extends BaseFragment<IOutSaleView, OutSalePresenter> implements IOutSaleView, FragmentBackHandler {
    ...
    public static OutSaleAddFragment newInstance() {
        Bundle args = new Bundle();
        OutSaleAddFragment fragment = new OutSaleAddFragment();
    ...
    private ShipPlanBean mChooseBean = new ShipPlanBean();

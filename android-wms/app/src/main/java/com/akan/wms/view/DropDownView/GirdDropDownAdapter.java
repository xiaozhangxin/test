package com.akan.wms.view.DropDownView;
    ...
    private void fillValue(int position, ViewHolder viewHolder) {
        ...
        if (checkItemPosition != -1) {
            if (checkItemPosition == position) {
                ...
                viewHolder.mText.setCompoundDrawablesWithIntrinsicBounds(null, null, context.getResources().getDrawable(R.drawable.choose_now), null);
            } else {
                viewHolder.mText.setTextColor(context.getResources().getColor(R.color.colorTextG3));

...
import com.akan.wms.mvp.adapter.home.TransferDetailAdapter;
...
public class TransferDetailFragment extends BaseFragment<ITransferView, TransferPresenter> implements ITransferView {
    ...
    private List<LineBeanListBean> list;
    ...
    public static TransferDetailFragment newInstance(String id) {
    ...
    public int getRootViewId() {
        return R.layout.fragment_detail_transfer;
    }

    @Override
    public void initUI() {
        tvTitle.setText("同组织调拨详情");
        stateOne.setText("已配货");
        stateTwo.setText("已审核");

        list = new ArrayList<>();
        recyclerView.setLayoutManager(new LinearLayoutManager(context));
        adapter = new TransferDetailAdapter(context, list);
    ...
    private void getData() {
        map.put("id", mId);
        getPresenter().queryTransferOutInById(userBean.getStaff_token(), map);
    }
    ...
    public void onQueryTransferOutInById(TransferBean data) {
        ...
        tvFour.setText(data.getOut_wh_name());
        tvFive.setText(data.getIn_wh_name());
    ...
    private void showDialog() {
        ...
        builder.setPositiveButton(R.string.sure, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                map.clear();
                map.put("id", mId);
                getPresenter().auditOutAndIn(userBean.getStaff_token(), map);
            }
    ...
    public void OnAuditOutAndIn(String data) {
        LoadingUtil.closeDialog(loading);
        ToastUtil.showToast(context.getApplicationContext(), "审核成功");
